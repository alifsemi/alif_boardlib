...
void BOARD_Pinmux_Init()
{
	...
	PINPAD_Config(PORT_NUMBER_1, PIN_NUMBER_0, PAD_FUNCTION_READ_ENABLE);
	...
	PINPAD_Config(PORT_NUMBER_5, PIN_NUMBER_2, PAD_FUNCTION_READ_ENABLE);
	...
	/* CAMERA clock output */
	PINMUX_Config(PORT_NUMBER_10, PIN_NUMBER_3, PINMUX_ALTERNATE_FUNCTION_7);   // P10_3: CAM_XVCLK (mux mode 7)
	...
	PINPAD_Config(PORT_NUMBER_12, PIN_NUMBER_1, PAD_FUNCTION_READ_ENABLE);

	/* SPI3 interface */
	PINMUX_Config(PORT_NUMBER_12, PIN_NUMBER_4, PINMUX_ALTERNATE_FUNCTION_2);   // P12_4: MISO (mux mode 2)
	PINMUX_Config(PORT_NUMBER_12, PIN_NUMBER_5, PINMUX_ALTERNATE_FUNCTION_2);   // P12_5: MOSI (mux mode 2)
	PINMUX_Config(PORT_NUMBER_12, PIN_NUMBER_6, PINMUX_ALTERNATE_FUNCTION_2);   // P12_6: SCLK (mux mode 2)
	PINMUX_Config(PORT_NUMBER_12, PIN_NUMBER_7, PINMUX_ALTERNATE_FUNCTION_0);   // P12_7: GPIO (mux mode 0)
	PINPAD_Config(PORT_NUMBER_12, PIN_NUMBER_4, PAD_FUNCTION_READ_ENABLE);
	...
	PINPAD_Config(PORT_NUMBER_13, PIN_NUMBER_4, PAD_FUNCTION_READ_ENABLE);
