...
void BOARD_Pinmux_Init()
{
	...
	/* SPI3 interface */
	PINMUX_Config(PORT_NUMBER_2, PIN_NUMBER_21, PINMUX_ALTERNATE_FUNCTION_4);
	PINMUX_Config(PORT_NUMBER_2, PIN_NUMBER_22, PINMUX_ALTERNATE_FUNCTION_3);
	PINMUX_Config(PORT_NUMBER_2, PIN_NUMBER_23, PINMUX_ALTERNATE_FUNCTION_3);
