...
void BOARD_Pinmux_Init()
{
	...
	uint8_t config_pin_input_pullup =
			PAD_FUNCTION_READ_ENABLE |
			PAD_FUNCTION_DRIVER_DISABLE_STATE_WITH_PULL_UP |
	...
	*((uint32_t *)0x7100601C) = 0x11110330;	/* PINMUX for JTAG0 and OSPI0 on OUTPUT_A */
	...
	*((uint32_t *)0x71006038) = 0;
	...
	PINPAD_Config(BOARD_BUTTON1_GPIO_PORT, BOARD_BUTTON1_PIN_NO, config_pin_input_pullup);
	...
	PINPAD_Config(BOARD_BUTTON2_GPIO_PORT, BOARD_BUTTON2_PIN_NO, config_pin_input_pullup);
	...
	PINPAD_Config(BOARD_TOUCH_INT_GPIO_PORT, BOARD_TOUCH_INT_PIN_NO, config_pin_input_pullup);
