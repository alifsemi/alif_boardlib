...
void BOARD_Pinmux_Init()
{
	...
	uint32_t config_gpio_input =
			PAD_FUNCTION_READ_ENABLE |
			PAD_FUNCTION_SCHMITT_TRIGGER_ENABLE;

	uint32_t config_gpio_output =
			PAD_FUNCTION_READ_ENABLE;
	...
	*((uint32_t *)0x7100601C) = 0x11110011;	/* PINMUX for JTAG0 and SE-UART on OUTPUT_A */
	...
	*((uint32_t *)0x71006038) = 0;
	...
	PINPAD_Config(BOARD_BUTTON1_GPIO_PORT, BOARD_BUTTON1_PIN_NO, config_gpio_input);
	...
	PINPAD_Config(BOARD_BUTTON2_GPIO_PORT, BOARD_BUTTON2_PIN_NO, config_gpio_input);
	...
	PINPAD_Config(BOARD_LED1_GPIO_PORT, BOARD_LED1_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_LED2_GPIO_PORT, BOARD_LED2_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_LCD_RESET_GPIO_PORT, BOARD_LCD_RESET_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_LCD_BACKLIGHT_GPIO_PORT, BOARD_LCD_BACKLIGHT_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_TOUCH_RESET_GPIO_PORT, BOARD_TOUCH_RESET_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_TOUCH_INT_GPIO_PORT, BOARD_TOUCH_INT_PIN_NO, config_gpio_input);
	...
	PINPAD_Config(BOARD_CAMERA_RESET_GPIO_PORT, BOARD_CAMERA_RESET_PIN_NO, config_gpio_output);
	...
	PINPAD_Config(BOARD_CAMERA_POWER_GPIO_PORT, BOARD_CAMERA_POWER_PIN_NO, config_gpio_output);
