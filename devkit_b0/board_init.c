...
void BOARD_Pinmux_Init()
{
	...
	pinconf_set(BOARD_BUTTON1_GPIO_PORT, BOARD_BUTTON1_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_button);
	...
	pinconf_set(BOARD_BUTTON2_GPIO_PORT, BOARD_BUTTON2_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_button);
	...
	pinconf_set(BOARD_LED1_GPIO_PORT, BOARD_LED1_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_LED2_GPIO_PORT, BOARD_LED2_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_LCD_RESET_GPIO_PORT, BOARD_LCD_RESET_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_LCD_BACKLIGHT_GPIO_PORT, BOARD_LCD_BACKLIGHT_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_TOUCH_RESET_GPIO_PORT, BOARD_TOUCH_RESET_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_TOUCH_INT_GPIO_PORT, BOARD_TOUCH_INT_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	pinconf_set(BOARD_CAMERA_RESET_GPIO_PORT, BOARD_CAMERA_RESET_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
	...
	//pinconf_set(PORT_3,  PIN_6, PINMUX_ALTERNATE_FUNCTION_1, 0);   				// P3_6: XTAL_OUT (mux mode 1)
