/* Copyright (C) 2022-2025 Alif Semiconductor - All Rights Reserved.
...
/******************************************************************************
 * @file     board_DevKit.c
 * @brief    BOARD API implementation for Alif Development Kit
 ******************************************************************************/

#include "board.h"

#if defined(BOARD_IS_ALIF_DEVKIT_E8_VARIANT)
#include "soc.h"
#include "Driver_IO.h"
#include "pinconf.h"
...
void BOARD_Pinmux_Init()
    ...
    extern ARM_DRIVER_GPIO ARM_Driver_GPIO_(BOARD_CAMERA_DISPLAY_MUX_GPIO_PORT);
    ...
    ARM_DRIVER_GPIO *BOARD_CAMERA_DISPLAY_MUX_GPIOdrv = &ARM_Driver_GPIO_(BOARD_CAMERA_DISPLAY_MUX_GPIO_PORT);
    ...
    BOARD_CAMERA_DISPLAY_MUX_GPIOdrv->Initialize(BOARD_CAMERA_DISPLAY_MUX_GPIO_PIN_NO, NULL);
    BOARD_CAMERA_DISPLAY_MUX_GPIOdrv->PowerControl(BOARD_CAMERA_DISPLAY_MUX_GPIO_PIN_NO, ARM_POWER_FULL);
    BOARD_CAMERA_DISPLAY_MUX_GPIOdrv->SetValue(BOARD_CAMERA_DISPLAY_MUX_GPIO_PIN_NO, GPIO_PIN_OUTPUT_STATE_HIGH); // Set display as default
    BOARD_CAMERA_DISPLAY_MUX_GPIOdrv->SetDirection(BOARD_CAMERA_DISPLAY_MUX_GPIO_PIN_NO, GPIO_PIN_DIRECTION_OUTPUT);
    pinconf_set(PORT_(BOARD_CAMERA_DISPLAY_MUX_GPIO_PORT), BOARD_CAMERA_DISPLAY_MUX_GPIO_PIN_NO, PINMUX_ALTERNATE_FUNCTION_0, config_gpio);
    ...
    pinconf_set(PORT_10, PIN_7, PINMUX_ALTERNATE_FUNCTION_7, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST | PADCTRL_READ_ENABLE);    // RXDS
    ...
    /* Trace interface */
    pinconf_set(PORT_3, PIN_7, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);   // P3_7: TRACECLK (mux mode 1)
    pinconf_set(PORT_4, PIN_0, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);   // P4_0: TRACEDATA0 (mux mode 1)
    pinconf_set(PORT_4, PIN_1, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);   // P4_1: TRACEDATA1 (mux mode 1)
    pinconf_set(PORT_4, PIN_2, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);   // P4_2: TRACEDATA2 (mux mode 1)
    pinconf_set(PORT_4, PIN_3, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA | PADCTRL_SLEW_RATE_FAST);   // P4_3: TRACEDATA3 (mux mode 1)
}
